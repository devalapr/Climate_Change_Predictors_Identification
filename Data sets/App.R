...
library(dplyr)
library(readr)
TemperatureDatasetFinal= read_csv("TemperatureDatasetFinal.csv")
GDPDataSet = read_csv("GDPDataSet.csv")
PopulationDataset = read.csv("PopulationDataset_03_Preprocessed")
